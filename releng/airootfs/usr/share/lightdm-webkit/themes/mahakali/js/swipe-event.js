class SwipeEvent {
  ...
  _swipeEnd() {
    ...
    if (
      swipedPixelsY < swipedPixelsX &&
      swipedPixelsX >= this._thresholdPixel
    ) {
      // Swipes in x axis
      ...
      swipedPixelsY > swipedPixelsX &&
      swipedPixelsY >= this._thresholdPixel
    ) {
      // Swipes in y axis
  ...
  _createMouseEvent() {
    ...
    this._passedElement.addEventListener("touchend", (e) => {
    ...
    this._passedElement.addEventListener("mousedown", (e) => {
      this._startX = e.offsetX;
      this._startY = e.offsetY;
      this._startTime = new Date().getTime();
    });

    this._passedElement.addEventListener("mouseup", (e) => {
